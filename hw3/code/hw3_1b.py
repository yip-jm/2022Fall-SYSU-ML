...
def draw_pic(train_Loss, test_Loss, b_train_Loss, b_test_Loss):
    ...
    plt.plot(x_, train_Loss, 'ro-', color='g', alpha=1.0, linewidth=1.2, label='Train_alpha(0.00015)')
    plt.plot(x_, test_Loss, 'ro-', color='b', alpha=1.0, linewidth=1.2, label='Test_alpha(0.00015)')
    plt.plot(x_, b_train_Loss, 'ro-', color='tomato', alpha=1.0, linewidth=1.2, label='Train_alpha(0.000175)')
    plt.plot(x_, b_test_Loss, 'ro-', color='cyan', alpha=1.0, linewidth=1.2, label='Test_alpha(0.000175)')
...
theta = np.array([0,0,0])
theta, b_train_Loss, b_test_Loss = GradientDescent(x, y, theta, b_alpha, iters)
draw_pic(train_Loss, test_Loss, b_train_Loss, b_test_Loss)
print(b_train_Loss, b_test_Loss)
